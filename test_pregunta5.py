    ...
    def test_input(self):
        ...
        with patch('sys.stdin', StringIO(input_)) as mocked_stdin:
            with patch('sys.stdout', new=StringIO()) as mocked_stdout:
                ...
                "ERROR, no se pudo unificar t->t con Int\n" + menu_string + "\nERROR, ingresó más parámetros en ’eq’ de los que debería.\n" + menu_string + \
                "\nERROR, ingresó más parámetros en ’if’ de los que debería.\n" + menu_string + "\n"
